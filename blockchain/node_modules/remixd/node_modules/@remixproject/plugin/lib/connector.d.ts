 ...
 * ```
 */
export declare function connectClient(connector: ClientConnector, client?: PluginClient): PluginClient<any, Readonly<import("../../../../../dist/packages/api").IRemixApi>>;
 ...
 */
export declare const createConnectorClient: <P extends Api, App extends Readonly<{
    [name: string]: Api;
}> = Readonly<import("../../../../../dist/packages/api").IRemixApi>>(connector: ClientConnector, client?: PluginClient<P, App>) => Client<P, App>;
