...
class RemixdClient extends plugin_1.PluginClient {
    ...
    setupNotifications(path) {
        ...
        */
        this.watcher.on('change', (f) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        this.watcher.on('unlink', (f) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            if (this.isLoaded) {
                this.emit('removed', utils.relativePath(f, this.currentSharedFolder), false);
            }
        }));
        this.watcher.on('unlinkDir', (f) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            if (this.isLoaded) {
