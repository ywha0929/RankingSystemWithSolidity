...
function txDetails (e, tx, data, obj) {
  ...
  if (table && table.parentNode) {
    ...
    table = createTable({
      ...
      gas: data.tx.gas,
      input: data.tx.input,
      decodedInput: data.resolvedData && data.resolvedData.params ? JSON.stringify(typeConversion.stringify(data.resolvedData.params), null, '\t') : ' - ',
...
function createTable (opts) {
  ...
  if (opts['decoded input']) {
    ...
    <tr class="${css.tr}">
      ...
      <td class="${css.td}">${opts.decodedInput}
        ${copyToClipboard(opts.decodedInput)}
      </td>
    </tr>`
