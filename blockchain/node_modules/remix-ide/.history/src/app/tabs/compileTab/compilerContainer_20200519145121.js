...
class CompilerContainer {
  ...
  _updateVersionSelector (customUrl = '') {
    ...
    if (customUrl !== '') {
      ...
      url = `${this.data.baseURLList[this.data.selectedVersion]}/${this.data.selectedVersion}`
    }
  ...
  fetchAllVersion (callback) {
    ...
    if (allVersionsWasm && allVersionsWasm)
      allVersions.forEach((compiler) => {
        ...
        if (-1 !== rewritten) {
          ...
          baseURLList[compiler.path] = this.data.baseURLWasm
        } else {
          baseURLList[compiler.path] = this.data.baseURLBin
        }
      })
    callback(allVersions, selectedVersion)
  }
