...
import { canUseWorker, baseURLBin, baseURLWasm, urlFromVersion, allPaths } from '../../compiler/compiler-utils'
...
class CompilerContainer {
  ...
  _updateVersionSelector (customUrl = '') {
    ...
    if (customUrl !== '') {
      ...
      url = `${urlFromVersion(this.data.selectedVersion)}/${this.data.selectedVersion}`
    }
              ...
              try {
                ...
                allVersions.forEach((compiler) => {
                  ...
                  if (-1 !== rewritten) {
                    ...
                    allPaths[compiler.path] = baseURLWasm
                  } else {
                    allPaths[compiler.path] = baseURLBin
                  }
                })
