      ...
      results.map((result, j) => {
        ...
        result.report.map((item, i) => {
          ...
          if (item.location) {
            ...
            location = Object.keys((location.start.line + 1) + ':' + (location.start.column + 1) + ':'
          }
          warningCount++
          ...
          const msg = yo`
            <span class="d-flex flex-column">
              ...
              ${item.warning} 
              ${item.more ? yo`<span><br><a href="${item.more}" target="blank">more</a></span>` : yo`<span></span>`}
              <span class="h6">Pos: ${location}</span>
            </span>`
