        ...
        result.report.map((item, i) => {
          ...
          if (item.location) {
            ...
            location = self._deps.offsetToLineColumnConverter.offsetToLineColumn(location,
              ...
              locationString = (location.start.line + 1) + ':' + (location.start.column + 1) + ':'
          } else {
            locationString = 'not available'
            location.start.start = 0
          ...
          const msg = yo`
            <span class="d-flex flex-column">
              ...
              <span class="text-dark" title="Position in ${this.currentFile}">Pos: ${locationString}</span>
            </span>`
          self._components.renderer.error(
            ...
            this.view.querySelector(`[id="staticAnalysisModule${moduleName}"]`),
            {
              ...
              useSpan: true,
              errFile: this.currentFile,
              errLine: location.start.line + 1,
              errCol: location.start.column + 1
            }
          )
        })
      })
