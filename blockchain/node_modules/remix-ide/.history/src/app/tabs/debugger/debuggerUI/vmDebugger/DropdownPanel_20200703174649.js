...
DropdownPanel.prototype.render = function (overridestyle, node) {
  ...
  var title = !self.displayContentOnly ? yo`<div class="${css.title} py-0 px-1 title">
      ...
      <div onclick=${() => { self.copyClipboard() }} title='raw' class="${css.eyeButton} btn-sm far fa-clipboard"></div>
    </div>` : yo`<div></div>`
...
DropdownPanel.prototype.copyClipboard = function () {
  ...
  if (content) copyToClipboard(content.innerText ? content.innerText : content.textContent)
}
