...
function formatSelf (key, data) {
  ...
  return yo `<label style='${keyStyle};white-space:pre-wrap; margin-bottom: 0px;'> ${' ' + key}:<label style='${style}; margin-bottom: 0px;'>${' ' + data.self}</label><label style='font-style:italic'> ${data.isProperty || !data.type ? '' : ' ' + data.type}</label></label>`
}
