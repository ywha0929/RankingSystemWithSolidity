...
class ContractDropdownUI {
  ...
  render () {
    ...
    ? yo`<input id="deployAndRunPublishToIPFS" data-id="contractDropdownIpfsCheckbox" class="form-check-input custom-control-input mr-2" checked type="checkbox" onchange=${this.toggleCheckedState.bind(this)} >`
    : yo`<input id="deployAndRunPublishToIPFS" data-id="contractDropdownIpfsCheckbox" class="form-check-input custom-control-input mr-2" type="checkbox" onchange=${this.toggleCheckedState.bind(this)} >`

    this.deployCheckBox = yo`
      <div class="mx-2 d-flex pb-1 align-items-center custom-control custom-checkbox  align-items-start">
        ${this.ipfsCheckbox}
        <label
          for="deployAndRunPublishToIPFS"
          class="p-0 m-0 form-check-label custom-control-label"
