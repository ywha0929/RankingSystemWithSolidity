...
class ContractDropdownUI {
  ...
  render () {
    ...
    ? yo`<input id="deployAndRunPublishToIPFS" data-id="contractDropdownIpfsCheckbox" class="form-check-input custom-control-input" checked type="checkbox" onchange=${this.toggleCheckedState.bind(this)} >`
    : yo`<input id="deployAndRunPublishToIPFS" data-id="contractDropdownIpfsCheckbox" class="form-check-input custom-control-input" type="checkbox" onchange=${this.toggleCheckedState.bind(this)} >`
    ...
    this.deployCheckBox = yo`
      <div class="d-flex pb-1 align-items-center custom-control custom-checkbox">
        ...
        <label
          ...
          class="pt-2 m-0 form-check-label custom-control-label"
