...
export class SidePanel extends AbstractPanel {
  ...
  constructor (appManager, verticalIcons) {
    ...
    this.renderHeader().then(header => this.header = header)
  ...
  async showContent (name) {
    ...
    let newHeader = await this.renderHeader()
    yo.update(this.header, newHeader)
  }
  ...
  async render () {
    if (!this.header) this.header = await this.renderHeader()
    return yo`
