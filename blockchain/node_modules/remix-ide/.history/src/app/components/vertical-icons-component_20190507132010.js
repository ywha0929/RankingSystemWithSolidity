...
class VerticalIconComponent {
  ...
  render () {
    ...
    >
    <svg width="32px" height="32px" viewBox="0 0 512 512" enable-background="new 0 0 512 512" xml:space="preserve">
      <path id="home-icon"/>
    </svg>

    <image class="my-svg-alternate" width="96" height="96" src="assets/img/remix_logo_512x512.svg" />
    </div>`
