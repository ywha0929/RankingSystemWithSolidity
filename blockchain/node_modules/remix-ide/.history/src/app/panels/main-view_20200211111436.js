...
export class MainView {
  constructor (editor, mainPanel, fileManager, appManager, txListener, eventsDecoder, blockchain, contextualListener) {
    var self = this
  ...
  init () {
    ...
    */
    ...
    var contextView = new ContextView({contextualListener: self._components.contextualListener, editor: self.editor})
