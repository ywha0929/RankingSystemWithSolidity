...
export class PermissionHandler {
   ...
   * @param {String} from the profile name of the plugin that make the call
   * @param {String} to The profile name of the module that receive the call
   * @param {String} method The method to be called
   * @param {String} message From the caller
