...
export class LandingPage extends ViewPlugin {
  ...
  render () {
    ...
    */
    ...
    const container = yo`
    <div class="${css.homeContainer} bg-light" data-id="landingPageHomeContainer">
      <div class="d-flex flex-column alert alert-info py-3 ${css.thisJumboton}">
        <div>
        ...
        <div class="d-flex">
          ...
          <div class="${css.jumboBtnContainer} px-5">
            <button class="btn btn-sm btn-primary mx-3" href="#" onclick=${() => learnMore()} role="button">Learn more</button>
