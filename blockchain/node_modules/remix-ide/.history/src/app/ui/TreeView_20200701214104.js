...
class TreeView {
  ...
  formatData (key, data, children, expand, keyPath) {
    ...
    var label = yo`
      <div key=${keyPath} data-id="treeViewDiv${keyPath}" class="d-flex flex-row">
        ${caret}
  ...
  formatSelfDefault (key, data) {
    return yo`
      <div class="d-flex flex-row w-80 ${css.label_item}">
        <label class="text-nowrap font-weight-bold pr-1">${key}:</label>
