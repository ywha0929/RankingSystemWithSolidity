...
class MultiParamManager {
  ...
  render () {
    ...
    let funcButton = yo`<button onclick=${() => onClick()} class="${css.instanceButton} w-50 btn btn-sm">${title}</button>`
    ...
    var expandedButton = yo`<button onclick=${() => { multiOnClick() }} class="${css.instanceButton} w-50"></button>`
