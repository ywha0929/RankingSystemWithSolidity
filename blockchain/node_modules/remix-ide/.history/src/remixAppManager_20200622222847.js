...
const requiredModules = [ // services + layout views + system views
  'manager', 'compilerArtefacts', 'compilerMetadata', 'contextualListener', 'editor', 'offsetToLineColumnConverter', 'network',
  'theme', 'fileManager', 'contentImport', 'web3Provider', 'scriptRunner', 'fetchAndCompile',
...
export class RemixAppManager extends PluginManager {
  ...
  activatePlugin (name) {
    if (this.registeredPlugins().includes(name) && !this.actives.includes(name))
    super.activatePlugin(name)
  }
