...
UniversalDAppUI.prototype.renderInstanceFromABI = function (contractABI, address, contractName) {
  ...
  var close = yo`<button class="${css.udappClose} p-1 btn btn-secondary" onclick=${remove} title="Remove transaction"><i class="${css.closeIcon} fas fa-times" aria-hidden="true"></i></button>`
