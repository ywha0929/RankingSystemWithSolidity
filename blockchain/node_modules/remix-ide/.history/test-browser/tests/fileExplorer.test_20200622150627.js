...
module.exports = {
  ...
  'Should delete file `5_Renamed_Contract.sol` from file explorer': function (browser) {
    ...
    .waitForElementVisible('*[data-id="treeViewLibrowser/5_Renamed_Contract.sol"]')
    .pause(5000)
    .rightClick('[data-path="browser/5_Renamed_Contract.sol"]')    .pause(5000)
    .click('*[id="menuitemdelete"]')    .pause(5000)
    .waitForElementVisible('*[data-id="modalDialogContainer"]')    .pause(5000)
    .modalFooterOKClick()    .pause(5000)
    .waitForElementNotPresent('*[data-id="treeViewLibrowser/5_Renamed_Contract.sol"')    .pause(5000)
  },
