        ...
        contractHelper.switchFile(browser, 'browser/signMassage.sol', () => {
          contractHelper.selectContract(browser, 'SignMassageTest', () => { // deploy lib
            contractHelper.createContract(browser, '', () => {
              ...
              .clickFunction("ecrecovery - call", {types: "bytes32 hash, bytes sig", values: `"${hash}","${signature}"`}).perform(
                ()=>{
                  contractHelper.verifyCallReturnValue(browser, "0x692a70d2e424a56d2c6c27aa97d1a86395877b3a", ['0: address: 0xCA35b7d915458EF540aDe6068dFe2F44E8fa733c'] )
                  callback(null, browser)
                }
              )
            })
