...
module.exports = {
  ...
  'Should debug Ropsten transaction with source highlighting using the source verifier service and MetaMask': function (browser) {
    ...
    waitForElementVisible('*[data-id="treeViewLiloaded address"]', 30000)
    .assert.containsText('*[data-id="treeViewLiloaded address"]', '0x3c943Fb816694d7D1f4C738e3e7823818a88DD6C')
