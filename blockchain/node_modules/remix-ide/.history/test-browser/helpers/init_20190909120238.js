...
function initModules (browser, callback) {
  browser.pause(3000).click('#icon-panel div[plugin="pluginManager"]'), [], function () {
    browser.scrollInto('#pluginManager article[id="remixPluginManagerListItem_solidity"] button')
