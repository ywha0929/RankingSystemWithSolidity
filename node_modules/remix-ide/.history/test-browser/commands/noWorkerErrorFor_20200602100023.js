...
function noWorkerErrorFor (browser, version, callback) {
  browser
    ...
    .pause(5000) // to check if this is enough for compilation we use assert below
    .getAttribute('*[data-id="compilerContainerCompileBtn]"', 'disabled', (result) => { this.assert.equal(result.value, null) }) // element not disabled
