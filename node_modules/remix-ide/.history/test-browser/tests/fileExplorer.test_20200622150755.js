...
module.exports = {
  ...
  'Should create a new folder': function (browser) {
    browser
    .waitForElementVisible('*[data-id="treeViewLibrowser/1_Storage.sol"]')    .pause(5000)
    .rightClick('[data-path="browser/1_Storage.sol"]')    .pause(5000)
    .click('*[id="menuitemcreate folder"]')    .pause(5000)
    .waitForElementVisible('*[data-id="modalDialogContainer"]')
