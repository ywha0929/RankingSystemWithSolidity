 ...
 * @param version is the version of compiler with or without 'soljson-v' prefix
 */
export function urlFromVersion (version) {
  console.log("orig_________= " + version + " path =", pathToURL, " version =", version, " and url is = ", pathToURL[version])
  if (version.substr(0, 9) !== 'soljson-v') version = 'soljson-v' + version
  con
  return `${pathToURL[version] ? pathToURL[version] : baseURLBin}/${version}`
}
