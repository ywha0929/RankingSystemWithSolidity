...
class TreeView {
  ...
  formatData (key, data, children, expand, keyPath) {
    ...
    if (data.children) {
      ...
      caret.className = list.style.display === 'none' ? `fas fa-caret-right caret mb-1 ${css.caret_tv}` : `fas fa-caret-down caret mb-1 ${css.caret_tv}`
  ...
  expand (path) {
    ...
    if (node) {
      ...
      caret.className = node.style.display === 'none' ? `fas fa-caret-right caret mb-1 ${css.caret_tv}` : `fas fa-caret-down caret mb-1 ${css.caret_tv}`
