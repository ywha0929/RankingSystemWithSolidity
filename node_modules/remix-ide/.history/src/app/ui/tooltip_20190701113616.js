  ...
  render (tooltipText, actionElement, opts) {
    ...
    return new Promise((resolve, reject) => {
      ...
      let out = () => {
        ...
        progressTimeout = opts.time
      }
      this.id = timeOut()
      document.body.appendChild(this.tooltip)
      doProgress(opts.time)
...
function doProgress(time) {//4000
  let bar = new ProgressBar.Line(document.getElementById("progressBar"), {
    strokeWidth: 4,
    easing: 'easeInOut',
    duration: time,
    color: '#FFEA82',
