...
class ContextView {
  ...
  render () {
    const view = yo`<div class="${css.contextview} ${css.contextviewcontainer} bg-light text-dark border-0">
      ...
      if (node.name === 'FunctionDefinition') {
        ...
        return yo`
          <div class=${css.gasEstimation}>
            <div>
              <i class="${css.gasStationIcon} fas fa-gas-pump" title='Gas estimation'></i>
