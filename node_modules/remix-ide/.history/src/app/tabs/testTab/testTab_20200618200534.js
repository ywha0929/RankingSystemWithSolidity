...
class TestTabLogic {
  ...
  generateTestFile () {
    ...
    const fileNameToImport = (!hasCurrent) ? fileName : splittedFileName[splittedFileName.length - 1]
  ...
  generateTestContractSample (hasCurrent, fileToImport, contractName = 'testSuite') {
    const relative = remixPath.relative(this.currentPath, remixPath.dirname(fileToImport))
