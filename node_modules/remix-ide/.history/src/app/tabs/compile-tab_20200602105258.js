...
class CompileTab extends ViewPlugin {
  ...
  listenToEvents () {
    ...
    this.data.eventHandlers.onCompilationFinished = (success, data, source) => {
      this._view.errorContainer.appendChild(yo`<span data-id="compilationFinishedWith${this.getCurrentVersion()}"></span>`)
      if (success) {
