...
module.exports = class SettingsTab extends ViewPlugin {
  ...
  render () {
    ...
    const gistAccessToken = yo`<input id="gistaccesstoken" data-id="settingsTabGistAccessToken" type="password" class="form-control border mb-2 ${css.inline}" placeholder="Token">`
