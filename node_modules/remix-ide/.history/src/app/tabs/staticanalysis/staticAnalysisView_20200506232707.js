        ...
        result.report.map((item, i) => {
          ...
          const msg = yo`
            <span class="d-flex flex-column">
              ...
              <span class="" title="Position in ${this.currentFile} and ${Object.keys(self.lastCompilationResult.contracts)[file]}">Pos: ${locationString}</span>
            </span>`
          self._components.renderer.error(
            ...
            this.view.querySelector(`[id="staticAnalysisModule${moduleName}"]`),
            {
              ...
              useSpan: true,
              errFile: Object.keys(self.lastCompilationResult.contracts)[file],
              errLine: row,
              errCol: column
            }
          )
