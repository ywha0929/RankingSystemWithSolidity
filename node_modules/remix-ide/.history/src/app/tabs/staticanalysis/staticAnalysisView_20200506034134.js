    ...
    const groupedModules = utils.groupBy(preProcessModules(this.runner.modules()), 'categoryId')
      results.map((result, j) => {
        ...
        result.report.map((item, i) => {
          ...
          self._components.renderer.error(msg, document.querySelector(`[id="staticAnalysisModule${moduleName}"]`), {type: 'staticAnalysisWarning alert alert-warning', useSpan: true})
        })
      })
