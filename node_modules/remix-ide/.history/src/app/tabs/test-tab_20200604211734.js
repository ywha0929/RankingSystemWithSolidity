...
module.exports = class TestTab extends ViewPlugin {
  ...
  */
  ...
  render () {
    ...
    this.uiPathList = yo`<datalist id="utPathList"><option selected>browser/test</option></datalist>`
    const availablePaths = yo`
      <div>
        <input list="utPathList" class="custom-select" id="utPath" name="utPath" />
                ${this.uiPathList}
      </div>
    `
    let options = ['browser', 'browser/test']
