...
class CompilerContainer {
  ...
  fetchAllVersion (callback) {
    ...
    if (allVersionsWasm.length && allVersionsWasm.length)
      allVersionsWasm.forEach((compiler) => {
        const rewritten = allVersions.findIndex(oldCompiler => oldCompiler === compiler)
        allVersions[rewritten] = compiler
      })
    callback(allVersions, selectedVersion)
  }
