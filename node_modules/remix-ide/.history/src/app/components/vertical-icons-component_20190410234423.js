...
class VerticalIconComponent {
  ...
  select (name) {
    ...
    let currentActive = this.view.querySelector(`.${css.darktActive}`)
    let activeType
    if (themeType === 'light') {
      currentActive = this.view.querySelector(`.${css.lightActive}`)
      if (!currentActive)  this.view.querySelector(`.${css.darktActive}`)

      activeType = `${css.lightActive}`
    } else {
      currentActive = this.view.querySelector(`.${css.darktActive}`)
      if (!currentActive)  this.view.querySelector(`.${css.lightActive}`)
      activeType = `${css.darktActive}` 
    }
