            ...
            methodPermission.appendChild(yo`
              <div class="form-group ${css.permissionKey}">
                <div class="${css.checkbox}">
                  ${checkbox}
                  <label for="permission-${toPlugin}" data-id="pluginManagerSettingsPermission${toPlugin}">Allow <u>${fromPluginPermission}</u> to access <u>${funcName}</u></label>
                </div>
                <i onclick="${() => this.clearPersmission(fromPluginPermission, toPlugin)}" class="fa fa-trash-alt" data-id="pluginManagerSettingsRemovePermission${toPlugin}"></i>
              </div>
            `)
