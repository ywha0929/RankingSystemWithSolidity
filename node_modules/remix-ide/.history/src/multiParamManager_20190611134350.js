...
// TODO: if this is a lookup only make this button btn-success
// otherwise it needs to have btn-danger injected
...
// TODO: add class for btn-info to the button and remove stuff from the class
    if (this.lookupOnly) {
      ...
      this.contractActionsContainerSingle.querySelector(`.${css.instanceButton}`).classList.add('btn-success')
      button.classList.add('btn-success')
    } else {
      this.contractActionsContainerSingle.querySelector(`.${css.instanceButton}`).classList.add('btn-danger')
